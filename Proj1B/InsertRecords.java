...
public class InsertRecords {
		...
		while (x < 7){
			...
			switch (x) {
				...
				case 1:
					...
					break;
				case 2:
					sql += "VALUES (1003, 978012431, ‘John’, 'M', ‘1999/07/08’, ‘201W Hall', '5154132805’, ‘888 University’, ‘5152012011’)";
					break;
				case 3:
	...
	public static void insert_register() throws SQLException{
		...
		while (x < 7){
			...
			switch (x) {
				case 0:
					sql += "VALUES (1001, 363, ‘Fall2015’, 3)";
					break;
				case 1:
					sql += "VALUES (1002, 311, ‘Fall2015’, 4)";
					break;
				case 2:
					sql += "VALUES (1003, 228, ‘Fall2015’, 4)";
					break;
				case 3:
					sql += "VALUES (1004, 363, ‘Spring2015’, 3)";
					break;
				case 4:
					sql += "VALUES (1005, 531, ‘Spring2015’, 4)";
					break;
				case 5:
					sql += "VALUES (1006, 363, ‘Fall2015’, 3)";
					break;
				case 6:
					sql += "VALUES (1007, 531, ‘Spring2015’, 4)";
					break;
			}
			stmt.executeUpdate(sql);
			x++;
